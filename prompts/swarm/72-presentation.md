...
- No mocks — real devnet transactions, real AI narration, real demo execution, real-time commentary, real visualizations
...
2. **`PresentationConfig` interface** (extends `DemoConfig`):
   ...
   interface PresentationConfig extends DemoConfig {
     ...
     projectName: string;
     /** Hackathon name (shown on title card, for context) */

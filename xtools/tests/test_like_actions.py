...
from xtools.actions.types import TweetElement, LikeResult, LikeFilters, AutoLikeConfig
...
class TestLikeTweet:
    ...
    async def test_like_tweet_success(self, mock_browser, mock_rate_limiter):
        ...
        from xtools.actions.engagement.like import LikeTweet
...
class TestLikeByKeyword:
    ...
    async def test_like_by_keyword_basic(self, mock_browser, mock_rate_limiter):
        ...
        from xtools.actions.engagement.like import LikeByKeyword
...
class TestAutoLiker:
    ...
    async def test_auto_liker_initialization(self, mock_browser, mock_rate_limiter):
        ...
        from xtools.actions.engagement.like import AutoLiker

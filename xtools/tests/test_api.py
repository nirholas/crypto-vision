...
class TestAPIImports:
    ...
    def test_server_import(self) -> None:
        ...
        from xtools.api.server import app, run_server
...
class TestAPIModels:
    ...
    def test_scrape_request_model(self) -> None:
        ...
        from xtools.api.routes.scrape import ScrapeRepliesRequest
    ...
    def test_follow_request_model(self) -> None:
        ...
        from xtools.api.routes.follow import FollowUserRequest
    ...
    def test_engage_request_model(self) -> None:
        ...
        from xtools.api.routes.engage import LikeRequest
    ...
    def test_ai_generate_request_model(self) -> None:
        ...
        from xtools.api.routes.ai import GenerateContentRequest
    ...
    def test_sentiment_request_model(self) -> None:
        ...
        from xtools.api.routes.ai import SentimentRequest
...
class TestAPIRouters:
    ...
    def test_scrape_router_exists(self) -> None:
        ...
        from xtools.api.routes.scrape import router
...
class TestFastAPIApp:
    ...
    def test_app_title(self) -> None:
        ...
        from xtools.api.server import app

        assert "xtools" in app.title.lower() or "XTools" in app.title

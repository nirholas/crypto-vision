...
class TestProviderContextManager:
    ...
    async def test_openai_context_manager(self) -> None:
        ...
        with patch("xtools.ai.providers.openai.AsyncOpenAI") as mock_openai:
            mock_client = AsyncMock()
    ...
    async def test_anthropic_context_manager(self) -> None:
        ...
        with patch("xtools.ai.providers.anthropic.AsyncAnthropic") as mock_anthropic:
            mock_client = AsyncMock()
    ...
    async def test_ollama_context_manager(self) -> None:
        ...
        with patch("xtools.ai.providers.local.httpx.AsyncClient") as mock_httpx:
            mock_client = AsyncMock()

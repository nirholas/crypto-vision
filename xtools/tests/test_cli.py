...
from xtools.cli.main import cli, main
...
class TestMainCLI:
    ...
    def test_cli_help(self, runner: CliRunner) -> None:
        ...
        assert "XTools" in result.output or "xtools" in result.output.lower()

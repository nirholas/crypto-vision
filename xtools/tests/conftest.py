"""Shared test fixtures for XTools test suite."""
...
def sample_tweet_data() -> dict[str, Any]:
    ...
    return {
        ...
        "text": "This is a sample tweet for testing! #python #xtools",
...
def sample_user_data() -> dict[str, Any]:
    ...
    return {
        ...
        "username": "testuser",
        "name": "Test User",
        "description": "A test user for XTools testing",
...
def mock_ai_provider() -> AsyncMock:
    ...
    from xtools.ai.providers.base import AIResponse
...
def mock_env_vars() -> Generator[None, None, None]:
    ...
    os.environ.update(
        {
            "XTOOLS_OPENAI_API_KEY": "test-openai-key",
            "XTOOLS_ANTHROPIC_API_KEY": "test-anthropic-key",
            "XTOOLS_DISCORD_WEBHOOK": "https://discord.com/api/webhooks/test",
            "XTOOLS_TELEGRAM_BOT_TOKEN": "test-telegram-token",
            "XTOOLS_TELEGRAM_CHAT_ID": "123456789",
        }
    )
    yield
    os.environ.clear()

...
XTools can send notifications through multiple channels to keep you informed about your X/Twitter activity, alerts, and automation results.
...
# Send a message
await discord.send("🚀 XTools automation started!")
```
...
```python
# Simple message
await discord.send("Hello from XTools!")
...
await discord.send_embed({
    ...
    "footer": {"text": "Generated by XTools"},
...
```python
from xtools.notifications import SlackNotifier
...
ifttt = WebhookNotifier(
    url="https://maker.ifttt.com/trigger/xtools_event/with/key/..."
)
...
[xtools.notifications.discord]
webhook_url = "${DISCORD_WEBHOOK}"
username = "XTools Bot"
avatar_url = "https://..."

[xtools.notifications.telegram]
bot_token = "${TELEGRAM_BOT_TOKEN}"
chat_id = "${TELEGRAM_CHAT_ID}"

[xtools.notifications.email]
smtp_host = "smtp.gmail.com"
smtp_port = 587
username = "${SMTP_USER}"
password = "${SMTP_PASSWORD}"
from_email = "xtools@yourdomain.com"
...
```bash
# Test notifications
xtools notify test --channel discord --message "Test message"

# Send notification
xtools notify send "Hello!" --channels discord,telegram

# Configure notifications
xtools notify setup discord
xtools notify setup telegram
xtools notify setup email
```
